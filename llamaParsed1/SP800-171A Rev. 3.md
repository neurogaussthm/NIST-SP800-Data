...
- Section 3 provides assessment procedures for the security requirements in SP 800-171, including assessment objectives and potential assessment methods and objects for each.
```# Procedure
...
**ASSESSMENT OBJECTIVE**
Determine if:# CURRENT_PAGE_RAW_OCR_TEXT

## A.03.01.01.ODP[01]
the time period for account inactivity before disabling is defined.

## A.03.01.01.ODP[02]
the time period within which to notify account managers and designated personnel or roles when accounts are no longer required is defined.

## A.03.01.01.ODP[03]
the time period within which to notify account managers and designated personnel or roles when users are terminated or transferred is defined.

## A.03.01.01.ODP[04]
the time period within which to notify account managers and designated personnel or roles when system usage or the need-to-know changes for an individual is defined.

## A.03.01.01.ODP[05]
the time period of expected inactivity requiring users to log out of the system is defined.
...
## A.03.01.01.g.03
account managers and designated personnel or roles are notified within <A.03.01.01.ODP[04]: time period> when system usage or the need-to-know changes for an individual.
...
# ASSESSMENT METHODS AND OBJECTS
Examine
[SELECT FROM: access control policy and procedures; personnel termination or transfer policies and procedures; procedures for account management; list of active]# CURRENT_PAGE_RAW_OCR_TEXT

## System Accounts
- System accounts and the name of the individual associated with each account;
- System design documentation; list of conditions for group and role membership;
- System configuration settings; notifications of recent transfers, separations, or terminations of employees;
...
- **A.03.01.10.ODP[01]:** one or more of the following PARAMETER VALUES are selected: {a device lock is initiated after <A.03.01.10.ODP[02]: time period> of```markdown
# Inactivity
...
### A.03.01.11.ODP[01]
Conditions or trigger events that require session disconnect are defined.

### A.03.01.11
A user session is terminated automatically after <A.03.01.11.ODP[01]: conditions or trigger events>.
...
### A.03.01.12.c[01]
Remote access to the system is routed through authorized access.
``````markdown
# Control Points
...
#### Test
[SELECT FROM: wireless access management capability for the system; mechanisms]
``````markdown
# CURRENT_PAGE_RAW_OCR_TEXT

for implementing wireless access protections to the system; mechanisms for managing the disabling of wireless networking capabilities
...
- A.03.02.01.ODP[04]: events that require security literacy training content updates.```markdown
# CURRENT PAGE RAW OCR TEXT

## A.03.02.01.a.01
- **[01]**: security literacy training is provided to system users as part of initial training for new users.
- **[02]**: security literacy training is provided to system users after initial training.

## A.03.02.01.a.02
- security literacy training is provided to system users when required by system changes or following events.

## A.03.02.01.a.03
- **[01]**: security literacy training is provided to system users on recognizing indicators of insider threat.
- **[02]**: security literacy training is provided to system users on reporting indicators of insider threat.
- **[03]**: security literacy training is provided to system users on recognizing indicators of social engineering.
- **[04]**: security literacy training is provided to system users on reporting indicators of social engineering.
- **[05]**: security literacy training is provided to system users on recognizing indicators of social mining.
- **[06]**: security literacy training is provided to system users on reporting indicators of social mining.

## A.03.02.01.b
- **[01]**: security literacy training content is updated frequency.
- **[02]**: security literacy training content is updated following events.
...
## ASSESSMENT OBJECTIVE
Determine if:
- **[01]**: the frequency at which to provide role-based security training to assigned personnel after initial training is defined.
- **[02]**: events that require role-based security training are defined.
- **[03]**: the frequency at which to update role-based security training content is defined.
- **[04]**: events that require role-based security training content updates are defined.
- **a.01[01]**: role-based security training is provided to organizational personnel before authorizing access to the system or CUI.
- **a.01[02]**: role-based security training is provided to organizational personnel before performing assigned duties.
- **a.01[03]**: role-based security training is provided to organizational personnel frequency after initial training.
- **a.02**: role-based security training is provided to organizational personnel.
```# Personnel

When required by system changes or following <A.03.02.02.ODP[02]: events>.
...
- A.03.03.02.a.03: audit records contain information that establishes where the event occurred.# CURRENT_PAGE_RAW_OCR_TEXT
...
## A.03.03.04.ODP[01]
the time period for organizational personnel or roles receiving audit logging process failure alerts is defined.

## A.03.03.04.ODP[02]
additional actions to be taken in the event of an audit logging process failure are defined.# A.03.03.04 Audit Logging
...
## ASSESSMENT OBJECTIVE
Determine if:
- A.03.03.06.a[01]: An audit record reduction and report generation capability that supports audit record review is implemented.# A.03.03.06 Audit Record Reduction and Report Generation
...
- **A.03.03.08.b**: access to management of audit logging functionality is authorized to# CURRENT_PAGE_RAW_OCR_TEXT

## only a subset of privileged users or roles.
...
## ASSESSMENT OBJECTIVE
Determine if:
- A.03.04.02.ODP[01]: configuration settings for the system that reflect the most# CURRENT PAGE RAW OCR TEXT
...
[SELECT FROM: personnel with configuration change control responsibilities; personnel with information security responsibilities; members of change control board or similar; system administrators]```markdown
# Test
...
**Interview**
[SELECT FROM: personnel with logical access control responsibilities; personnel with physical access control responsibilities; personnel with information security]
```# CURRENT_PAGE_RAW_OCR_TEXT
...
### ASSESSMENT METHODS AND OBJECTS
**Examine**
- [SELECT FROM: configuration management policy and procedures; configuration management plan; procedures for the baseline configuration of the system; procedures for system component installations and upgrades; system component inventory; system component installations or upgrades and associated records;]
```# CURRENT_PAGE_RAW_OCR_TEXT
...
**Interview**
**[SELECT FROM:** personnel with responsibilities for device identification and authentication]```markdown
# CURRENT_PAGE_RAW_OCR_TEXT

## authentication; personnel with information security responsibilities; system developers; system administrators
...
``````markdown
# A.03.05.05 Identifier Management
...
# A.03.05.07 Password Management
...
### A.03.05.07.ODP[02]
password composition and complexity rules are defined.

### A.03.05.07.a[01]
a list of commonly used, expected, or compromised passwords is maintained.

### A.03.05.07.a[02]
a list of commonly used, expected, or compromised passwords is updated <A.03.05.07.ODP[01]: frequency>.
...
### A.03.05.07.f
the following composition and complexity rules for passwords are enforced: <A.03.05.07.ODP[02]: rules>.
...
#### Examine
[SELECT FROM: incident response policy and procedures; procedures for incident]# CURRENT_PAGE_RAW_OCR_TEXT
...
- A.03.06.04.b[01]: Incident response training content is reviewed <A.03.06.04.ODP[03]: frequency>.# A.03.06.04 Incident Response Training

## A.03.06.04.b[02]
Incident response training content is updated
**<A.03.06.04.ODP[03]: frequency>.**

## A.03.06.04.b[03]
Incident response training content is reviewed following
**<A.03.06.04.ODP[04]: events>.**

## A.03.06.04.b[04]
Incident response training content is updated following
**<A.03.06.04.ODP[04]: events>.**
...
## Information Security Responsibilities; System Administrators
...
## 03.08.02: Access to CUI on System Media
...
#### A.03.10.01.ODP[01]
The frequency at which to review the access list detailing authorized facility access by individuals is defined.
...
#### A.03.10.01.c
The facility access list is reviewed <A.03.10.01.ODP[01]: frequency>.
...
**Interview**
[SELECT FROM: personnel approving the use of alternate work sites; personnel using]
```# CURRENT_PAGE_RAW_OCR_TEXT
...
- List of output devices and
**]**# CURRENT_PAGE_RAW_OCR_TEXT

## Associated Outputs
Outputs that require physical access controls; actual displays from system components; physical access control logs or records for areas containing output devices and related outputs; system security plan; other relevant documents or records.
...
- **A.03.11.02.a[01]:** the system is monitored for vulnerabilities <A.03.11.02.ODP[01]: frequency>.```markdown
# CURRENT_PAGE_RAW_OCR_TEXT
...
## A.03.11.02.b
system vulnerabilities are remediated within

## A.03.11.02.ODP[03]
response times.

## A.03.11.02.c[01]
system vulnerabilities to be scanned are updated
...
## A.03.12.01.ODP[01]
the frequency at which to assess the security requirements for the system and its environment of operation is defined.

## A.03.12.01
the security requirements for the system and its environment of operation are defined.
``````markdown
# CURRENT_PAGE_RAW_OCR_TEXT

## Operation Assessment
Operation are assessed <A.03.12.01.ODP[01]: frequency> to determine if the requirements have been satisfied.
...
#### Examine
[SELECT FROM: security assessment and monitoring policy and procedures; organizational continuous monitoring strategy; system-level continuous monitoring strategy; procedures for continuous monitoring of the system; procedures for
...
## Assessment Objective
Determine if:
- **A.03.13.01.a[01]:** communications at external managed interfaces to the system```markdown
# CURRENT_PAGE_RAW_OCR_TEXT
...
``````markdown
# A.03.13.06[02]: Network Communications Traffic
...
- **A.03.13.12.ODP[01]:** exceptions where remote activation is to be allowed are# CURRENT_PAGE_RAW_OCR_TEXT

## defined.

### A.03.13.12.a
the remote activation of collaborative computing devices and applications is prohibited with the following exceptions: `<A.03.13.12.ODP[01]: exceptions>`.
...
#### Examine
[SELECT FROM: system and communications protection policy and procedures; procedures for session authenticity; system design documentation; system configuration settings; system audit records; system security plan; other relevant]```markdown
# CURRENT_PAGE_RAW_OCR_TEXT
...
- A.03.14.02.c.01[02]: malicious code protection mechanisms are configured to
```# CURRENT PAGE RAW OCR TEXT
...
### ASSESSMENT METHODS AND OBJECTS
**Examine**
- [SELECT FROM: system and information integrity policy and procedures; laws, Executive Orders, directives, policies, regulations, standards, and operational requirements applicable to information management and retention; records]
```# CURRENT_PAGE_RAW_OCR_TEXT
...
- **A.03.15.02.a.07**: a system security plan that identifies individuals that fulfill# System Security Plan Development
...
### Test
[SELECT FROM: processes for establishing, reviewing, disseminating, and updating]# Rules of Behavior
...
- **A.03.16.03.ODP[01]:** security requirements to be satisfied by external system service providers are defined.```markdown
# A.03.16.03 External System Services

## A.03.16.03.a
The providers of external system services used for the processing, storage, or transmission of CUI comply with the following security requirements:
...
the system, system components, or system services.

## A.03.17.01.b[01]:
the SCRM plan is reviewed <A.03.17.01.ODP[01]: frequency>.

## A.03.17.01.b[02]:
the SCRM plan is updated <A.03.17.01.ODP[01]: frequency>.
...
## Examine
[SELECT FROM: SCRM policy and procedures; SCRM plan; system and services acquisition policy and procedures; procedures for supply chain protection; procedures for the integration of information security requirements into the acquisition process; solicitation documentation; acquisition documentation (including purchase orders); service-level agreements; acquisition contracts for the system, system components, or services; documentation of identified supply chain]
```# CURRENT PAGE RAW OCR TEXT
